...
import ticketimage from 'assets/img/lotteryticket.png';
...
var Icon$q = function (props) {
    return React.createElement("img", { width: "32", height: "32", src: "/images/egg/logo.png", className:"mobile-icon"});
};
...
var LinkExternal = function (_a) {
    ...
    return (React.createElement(Link, __assign({ external: true,color:"secondary" }, props),
        children,
        React.createElement(Icon$t, { color: "text", ml: "4px" })));
};

var Bar = styled.div(templateObject_1$p || (templateObject_1$p = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  background-color: ", ";\n  border-top-left-radius: 32px;\n  border-bottom-left-radius: 32px;\n  height: 16px;\n  transition: width 200ms ease;\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  background-color: ", ";\n  border-top-left-radius: 32px;\n  border-bottom-left-radius: 32px;\n  height: 16px;\n  transition: width 200ms ease;\n"])), function (props) { return (props.primary ? props.theme.colors.primary + "80" : props.theme.colors.primary + "00"); });
Bar.defaultProps = {
    primary: false,
};
    ...
    return (React.createElement(StyledModal, null,
        React.createElement(ModalHeader, null,
            React.createElement(ModalTitle, null,
                onBack && (React.createElement(IconButton, { variant: "tertiary", onClick: onBack, "area-label": "go back", mr: "8px" },
                    React.createElement(Icon$5, { color: "primary" }))),
                React.createElement(Heading, null, title)),
            !hideCloseButton && (React.createElement(IconButton, { variant: "tertiary", onClick: onDismiss, "aria-label": "Close the dialog" },
...
var Logo = function (_a) {
    ...
    return React.createElement("img", { width: "120", src: isDark ? '/images/egg/LogoTextNewDark.png' : '/images/egg/LogoTextNewWhite.png', className: "desktop-icon"});
};
...
var Icon$X = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M19,8L15,12H18A6,6 0 0,1 12,18C11,18 10.03,17.75 9.2,17.3L7.74,18.76C8.97,19.54 10.43,20 12,20A8,8 0 0,0 20,12H23M6,12A6,6 0 0,1 12,6C13,6 13.97,6.25 14.8,6.7L16.26,5.24C15.03,4.46 13.57,4 12,4A8,8 0 0,0 4,12H1L5,16L9,12" })));
};
...
var Icon$Jangle = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
...
var IconModule = /*#__PURE__*/Object.freeze({
    ...
    LayerIcon: Icon$11,
    RoadmapIcon: Icon$12,
    PriceGuardIcon: Icon$P,
    ListingIcon: Icon$Lt,
    DocIcon: Icon$Doc,
    MediumIcon: Icon$Md,
    JungleIcon: Icon$Jangle,
});
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "0px" }, isPushed ? (React.createElement(Icon$L, { width: "24px", color: "secondary" })) : (React.createElement(Icon$K, { width: "24px", color: "secondary" }))),
...
var socials = [
    ...
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/LeopardSwap",
    },
    {
        label: "Telegram",
        icon: "TelegramIcon",
        href: "https://t.me/LeopardSwap",
        // items: [
        //     {
        //         label: "English",
...
var MenuEntry = styled.div(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", "px;\n  padding: ", ";\n  font-size: ", ";\n  background-color: ", ";\n  color: ", ";\n  box-shadow: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"], ["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", "px;\n  padding: ", ";\n  font-size: ", ";\n  background-color: ", ";\n  color: ", ";\n  box-shadow: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"])), MENU_ENTRY_HEIGHT, function (_a) {
    ...
    return (secondary ? theme.colors.primaryDark : "transparent");
}, function (_a) {
    var theme = _a.theme;
    return theme.colors.text;
}, function (_a) {
    var isActive = _a.isActive, theme = _a.theme;
    return (isActive ? "inset 4px 0px 0px " + theme.colors.textSubtle : "none");
}, function (_a) {
    var theme = _a.theme;
    return theme.colors.textSubtle;
}, function (_a) {
...
var PanelBody = function (_a) {
    ...
    return (React.createElement(Container$3, null, links.map(function (entry) {
        ...
        var iconElement = React.createElement(Icon, { width: "24px", mr: "8px", color: 'text' });
...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container$4, null,
        React.createElement(SocialEntry, { style:{display: "block",height: "max-content"} },
            ...
            React.createElement(Flex, { style:{marginTop: "1em",justifyContent: "space-between" } }, socials.map(function (social, index) {
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React.createElement(HelpLink, { href: "https://docs.pancakeswap.finance/guides/faq#how-do-i-set-up-my-wallet-on-binance-smart-chain", external: true },
            React.createElement(Icon$o, { color: "text", mr: "6px" }),
...
var CopyToClipboard = function (_a) {
    ...
    return (React.createElement(StyleButton, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React.createElement(Icon$n, { width: "20px", color: "text", ml: "4px" }),
...
var UserBlock = function (_a) {
    ...
    var accountEllipsis = account ? account.substring(0, 4) + "..." + account.substring(account.length - 2) : null;
    
    return (React.createElement("div", {style:{display:"flex"} }, (React.createElement(LinkExternal1, { small: true, href: "https://polygon.leopardswap.net/", mr: "10px",style:{display:"inline-block"} }, (React.createElement(Button, { size: "sm"},"To Matic")))),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#260c05", backgroundDisabled: "#000000", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#ff720d", tertiary: "#EFF4F5", text: "#ffffff", textDisabled: "#666171", textSubtle: "#ff720d", borderColor: "#524B63", card: "#111111", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#8c9ecd", background: "#260c05", backgroundDisabled: "#EFF4F5", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#EFF4F5", primaryDark: "#0098A1", tertiary: "#EFF4F5", text: "#32a1b7", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "#32a1b7", gradients: {
