...
const AddTokenCard = () => {
  ...
  const [tokenAddress, setTokenAddress] = useState("0x5cA3F4B6AB74B49285AAa137E42b9e4A57Bb34f2")
      ...
      <div style={{width: "80%",margin: "0 auto", marginTop: "3em"}}>
        ...
        <ItemDiv style={{marginTop: "1em"}}>
          ...
          <ChildDiv>
            ...
            onClick={buyToken}
            >
              Buy LEOPARD to <img src="/images/LeoparSmall.png" alt="LEOPARD"/></Button>
          </ChildDiv>
        </ItemDiv>
      </div>
    </MainContainer>
